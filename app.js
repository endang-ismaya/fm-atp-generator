...
const presets = {
  ...
  delPiero: {
    label: "Alessandro Del Piero Prime",
    values: {
      Technique: 19,
      "First Touch": 18,
      Flair: 18,
  ...
  ibrahimovic: {
    label: "Zlatan Ibrahimovic Prime",
    values: {
      Finishing: 18,
      Heading: 17,
      Strength: 19,
